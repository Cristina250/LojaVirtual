...
$buscaDigitada = $_POST['busca'];
//$texto = explode(" ",$buscaDigitada);

$comando = mysqli_query($con,"SELECT * FROM produto WHERE nome LIKE '%$buscaDigitada%'");
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-9">
        ...
        <div class="row">
          <?php
            while($linha = mysqli_fetch_assoc($comando))
            {
           ?>
